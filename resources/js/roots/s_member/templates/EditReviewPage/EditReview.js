...
export default class EditReview  extends Component {
        ...
        */
        render() {
                ...
                document.title =  review_title + " | Edytuj recenzje";
                                        ...
                                        <div className="n-review__block">
                                                <header className="n-review__header n-review__header_modifier">
                                                        ...
                                                        <div className="n-review__header-content">
                                                                <h1 className="n-review__header-content--title"> Edytuj recenzje </h1>

                                                                <p className="n-review__header-content--subtitle"> Pulpit | Edytuj recenzje </p>
                                                        </div>
                                                </header>
