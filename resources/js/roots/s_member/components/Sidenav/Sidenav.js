                                ...
                                <div className="sidenav__block sidenav__block_modifier">
                                        <ul className="sidenav__list">
                                                <li className="sidenav__list-item">
                                                        <NavLink to="/member/overview" className="sidenav__list-link sidenav__list-link_effect" target="_self" activeClassName="sidenav__list-link--active"  exact={true}> <i className="material-icons material-icons-outlined"> home </i> <span className="sidenav__list-link-caption">Przegląd </span></NavLink>
                                                </li>
