...
<!--  Meta Data  -->
    ...
    <link rel="canonical" href="@yield('canPageUrl')">
    <link rel="alternate" href="@yield('altPageUrlPL')" hreflang="pl-POL">
    ...
    <!--  Scripts  -->
    <script defer src="{{ url(mix('js/app.js')) }}" crossorigin="anonymous"></script>
    ...
    })(window,document,'script','dataLayer','GTM-NXG32G7');
    </script>

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140846988-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-140846988-1');
    </script>
